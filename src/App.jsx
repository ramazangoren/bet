...
import otomatik_havale from './assets/otomatik_havale.jpeg';
...
const heroCards = [
  {
    title: '30.000₺ Hoş Geldin Bonusu Haftasonuna Özel 30.000₺ ye kadar hoş geldin bonusu fırsatı!',
    accent: 'pink',
    image: otomatik_havale,
    href: 'https://www.betmartin247.com/affiliates/?btag=2710206',
    ratio: 16 / 1,
    height: 120,
    contain : "fill"
  },
...
const bonusItems = [
  {
    image: hadiwin,
    text: 'İlk yatırımına özel %100 Spor & Slot Hoş Geldin Bonusu ile oyuna güçlü bir başlangıç yap',
    badge: true,
    href: 'http://hadiwin.direct/#/?btag=2710669'
  },
  {
    image: otomatik_havale,
    text: '30.000₺ Hoş Geldin Bonusu Haftasonuna Özel 30.000₺ ye kadar hoş geldin bonusu fırsatı!',
    badge: true,
    href: 'https://www.betmartin247.com/affiliates/?btag=2710206',
  },
  {
...
function PromoTile({ image, title, accent, href, ratio, height, contain }) {
      ...
      >
        <AspectRatio ratio={ratio} style={{ width: '100%' }}>
          <Image src={image} alt={title} fit={contain}
            style={{ opacity: hovered ? 1 : 0.88, transition: 'opacity 0.15s', height: height }} />
        </AspectRatio>
...
// // original code before refactor, for reference:
// import React, { useState } from 'react';
// import {
//   MantineProvider,
//   AppShell,
...
// const heroCards = [
//   { title: '30.000₺ Hoş Geldin Bonusu Haftasonuna Özel 30.000₺’ye kadar hoş geldin bonusu fırsatı!', accent: 'pink', image: otomatik_havale, href: 'https://www.betmartin247.com/affiliates/?btag=2710206' },
//   { title: '100 FREE SPIN AL!', accent: 'yellow', image: hadiwin, href: 'http://hadiwin.direct/#/?btag=2710669' },
//   { title: '1.000 TL YATIR - 250 TL AL!', accent: 'violet', image: betbalina, href: 'https://www.betbalina134.com/tr/casino/slots' },
// ];
...
//   { image: otomatik_havale, text: '30.000₺ Hoş Geldin Bonusu Haftasonuna Özel 30.000₺’ye kadar hoş geldin bonusu fırsatı!', badge: true, href: 'https://www.betbalina134.com/tr/casino/slots' },
